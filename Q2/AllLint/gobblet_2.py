...
def main():
    ...
    while True:
        ...
        for i in range(4):
            ...
            pygame.draw.line(screen, BLACK, (start_x, GRID_OFFSET), (start_x, WINDOW_SIZE - GRID_OFFSET), 4)
            pygame.draw.line(screen, BLACK, (GRID_OFFSET, start_y), (WINDOW_SIZE-GRID_OFFSET, start_y), 4)
        ...
        current_player_text  = font.render(f"Current Player: {board.current_player}", True, RED if board.current_player==1 else BLUE)
